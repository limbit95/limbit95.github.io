...
현재 개발 위치는 **Phase 7A 경매 완료, Phase 7B 거래/협상 완료, Phase 7C 자산 매각 기반 파산 회피 authoritative RPC 진행 중**입니다.
...
현재는 **Phase 7C — Debt Recovery / Asset Liquidation**의 foundation, Classic v1 50% 환급 정책, lifecycle, deterministic settlement, Game Engine wrapper, local runtime 연결을 완료했고, 기존 `marble_roll_dice`를 재정의하지 않는 authoritative liquidation RPC를 연결하고 있습니다.
