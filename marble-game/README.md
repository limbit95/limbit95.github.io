...
현재 개발 위치는 **Phase 7A 경매 완료, Phase 7B 거래/협상 완료, Phase 7C 자산 매각 기반 파산 회피 온라인 UI 진행 중**입니다.
...
현재는 **Phase 7C — Debt Recovery / Asset Liquidation**의 foundation, Classic v1 50% 환급 정책, lifecycle, deterministic settlement, Game Engine wrapper, local runtime, authoritative liquidation RPC, isolated DB 검증, Realtime/reconnect 연결까지 완료했고 온라인 자산 매각 UI를 연결하고 있습니다.
