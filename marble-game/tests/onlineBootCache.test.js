...
test("online Marble boot entry bypasses stale Pages module caches", () => {
  ...
  assert.match(indexHtml, /marbleBootstrap\.js\?v=20260919-r13/);
  ...
  assert.match(indexHtml, /auction-ui\.css\?v=20260919-r3/);
  ...
  assert.match(bootstrapSource, /playWindow\.js\?v=20260919-r13/);
  assert.match(playWindowSource, /ONLINE_BOOT_REVISION = "20260919-r13"/);
