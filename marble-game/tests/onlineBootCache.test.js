...
test("online Marble boot entry bypasses stale Pages module caches", () => {
  assert.match(indexHtml, /data-marble-build="20260922-r6"/);
  assert.match(indexHtml, /marbleBootstrap\.js\?v=20260922-r6/);
  ...
  assert.match(indexHtml, /auction-ui\.css\?v=20260922-r5/);
  ...
  assert.match(bootstrapSource, /playWindow\.js\?v=20260922-r6/);
  assert.match(playWindowSource, /ONLINE_BOOT_REVISION = "20260922-r6"/);
