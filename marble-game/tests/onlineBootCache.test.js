...
test("online Marble boot entry bypasses stale Pages module caches", () => {
  assert.match(indexHtml, /data-marble-build="20260921-r15"/);
  assert.match(indexHtml, /marbleBootstrap\.js\?v=20260921-r15/);
  ...
  assert.match(indexHtml, /auction-ui\.css\?v=20260921-r5/);
  ...
  assert.match(bootstrapSource, /playWindow\.js\?v=20260921-r15/);
  assert.match(playWindowSource, /ONLINE_BOOT_REVISION = "20260921-r15"/);
