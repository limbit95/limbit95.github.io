...
const unifiedDeductionEntrySource = readFileSync(new URL("../js/renderer/threeClassicUnifiedDeductionEntry.js", import.meta.url), "utf8");
...
test("online recovery and Classic renderer entries bypass stale modules while untouched imports stay pinned", () => {
  ...
  assert.match(indexHtml, /threeClassicMoneyPresentation\.js\?v=20260915-r1\": \"\.\/js\/renderer\/threeClassicMoneyPresentation\.js\?v=20260916-r1/);
  ...
  assert.match(unifiedDeductionEntrySource, /threeClassicPerformanceEntry\.js\?v=20260916-r4-base/);
