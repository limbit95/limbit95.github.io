...
-- Standalone reference SQL. This reflects the final 99P reward-cap behavior.
-- Production deployment should use supabase/liar-game/migrations/20260828_01...07 in order.
