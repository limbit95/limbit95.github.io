...
- 플레이 핵심 버튼은 개인 패널의 `거절하기 · 칩 1개 내기`, `카드 가져오기 · +N칩`으로 통합합니다. 칩이 0개이거나 본인 turn이 아니면 기존 server-authoritative 가능 여부에 맞춰 비활성화합니다.
...
- 다른 플레이어 공개 카드 popover는 후속 Phase E, refuse/take 카드·칩 이동 연출은 후속 Phase F로 분리합니다.
