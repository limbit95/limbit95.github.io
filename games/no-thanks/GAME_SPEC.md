...
> 실제 기능 개발 진행 상황은 같은 디렉터리의 `DEVELOPMENT.md`에서 관리합니다.
> UI/presentation은 같은 디렉터리의 `UI_DESIGN.md` adoption baseline과 `UI_DECISIONS.md`의 최신 non-superseded 변경 결정을 함께 적용합니다.
