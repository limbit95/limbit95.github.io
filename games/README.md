...
- 사용자가 `체크포인트 기록하자`라고 요청하면 해당 게임의 `DEVELOPMENT.md`를 현재 상태로 갱신하고 유효한 현재 작업 브랜치에 commit합니다. 그 외 일반적인 새 채팅용 정리·문서·요약 요청은 repository checkpoint 명령으로 확대 해석하지 않습니다.
