...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil((async () => {
    ...
    const sameTarget = windows.find((client) => new URL(client.url).href === targetUrl);
    if (sameTarget) {
      sameTarget.postMessage({ type: PUSH_NOTIFICATION_OPEN_MESSAGE, target_path: targetPath });
