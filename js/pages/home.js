...
function createHomeGamesCard() {
  return el("section", {
    ...
    el("div", {
      className: "home-games-card__icon",
      text: "🎮",
      "aria-hidden": "true",
    }),
    el("div", { className: "home-games-card__content" }, [
      el("p", { className: "eyebrow", text: "PLAY TOGETHER" }),
      el("h2", { id: "home-games-title", className: "section-title", text: "같이 놀기" }),
      el("p", { className: "subtle", text: "친구들과 함께 즐길 게임을 만나보세요." }),
    ]),
    el("a", {
      className: "button button--coral home-games-card__action",
      href: "#/games",
      text: "게임 둘러보기 →",
    }),
  ]);
