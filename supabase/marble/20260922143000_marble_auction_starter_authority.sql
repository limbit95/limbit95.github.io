-- Replace the legacy opening-bidder semantics with one server-authoritative auction starter.
-- The selected starter receives the first actionable bid turn; no bid exists before a player submits one.
-- Intro timing: 2s announcement -> 2.8s profile selector -> 0.8s result hold -> bidding.
