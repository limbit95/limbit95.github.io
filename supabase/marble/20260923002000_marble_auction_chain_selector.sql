-- Align Marble auction starter authority with the profile-chain selector.
-- The selected starter owns the first actionable turn; legacy opening-bid/requester aliases stay removed.
-- Game snapshots expose avatar_path so the selector can render account profile images.
