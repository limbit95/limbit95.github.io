-- Marble auction final bid settlement and bid surge metadata
-- The submitted bid must remain the settlement amount when that bid immediately
-- makes every other participant unable to afford the next minimum bid.
