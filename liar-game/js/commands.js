...
export const commands={
 ...
 startRound:(version)=>mutate("liar_start_round",{p_expected_room_version:version}), restartGame:(version)=>mutate("liar_restart_game",{p_expected_round_version:version}), markRoleChecked:()=>mutate("liar_mark_role_checked"),
