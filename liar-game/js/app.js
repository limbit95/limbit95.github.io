...
window.addEventListener("liar:auth-user-changed",()=>{clearVoteDraft();store.set({resultState:null});hydrateCurrentUser().catch(error=>store.set({message:messageFor(error)}));});
